...
: ${AMENT_CURRENT_PREFIX:="/home/autopilot03/Desktop/f1tenth_test0806/f1tenth_project_repo/install/camera_driver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/camera_driver/environment/library_path.sh"
