...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("straight_speed_scale", default_value="1.5"),
        DeclareLaunchArgument("curve_speed_scale", default_value="1.1"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "straight_speed_scale": LaunchConfiguration("straight_speed_scale"),
                "curve_speed_scale": LaunchConfiguration("curve_speed_scale"),
