...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("curve_exit_straight_deg", default_value="12.0"),
        DeclareLaunchArgument("curve_exit_opposition_deg", default_value="20.0"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "curve_exit_straight_deg": LaunchConfiguration("curve_exit_straight_deg"),
                "curve_exit_opposition_deg": LaunchConfiguration("curve_exit_opposition_deg"),
